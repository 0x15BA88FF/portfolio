...
export default function Home() {
    ...
    return (
			<section className="h-full w-full flex container mx-auto items-center justify-center pointer-events-none">
				<div className="flex flex-col gap-4 justify-center w-max">
					...
					<Link className="w-max py-3 px-8 sm:py-4 sm:px-10 border-2 rounded-md font-bold border-primary hover:bg-primary/40 pointer-events-auto" href="/about">About Me</Link>
				</div>
			</section>
    );
};
