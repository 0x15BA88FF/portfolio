...
export default function Home() {
  ...
  useEffect(_ => {
    ...
    return (
			<section className="h-full w-full container flex items-center justify-center mx-auto pointer-events-none backdrop-blur">
				<div className="w-max flex flex-col justify-center gap-4 p-4">
					...
					<Link href="/about" className="w-max py-3 px-8 sm:py-4 sm:px-10 font-bold bg-background-800/60 hover:bg-primary/20 border-primary border-2 rounded-md pointer-events-auto">About Me</Link>
				</div>
			</section>
    );
};
