...
export default function About() {
    return (
        <section className="h-full lg:flex lg:h-screen p-4 lg:p-0 lg:px-4 gap-8 p-4 overflow-y-scroll backdrop-blur-xl">
            <div className="lg:w-3/12 lg:h-full flex flex-col gap-4 py-4 lg:overflow-scroll">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <Link href="tel:+233545685910" className="flex items-center gap-2 pointer-events-auto">
                        <FaPhone className="w-[18px] h-[18px]"/>
                        <p>Contact</p>
                    </Link>
                    <Link href="mailto:15ba88+contact@proton.me" className="flex items-center gap-2 pointer-events-auto">
                        <FaEnvelope className="w-[18px] h-[18px]"/>
                        <p>Email</p>
                    </Link>
                    <Link href="https://github.com/0x15BA88FF" target="_blank" className="flex items-center gap-2 pointer-events-auto">
                        <FaGithub className="w-[18px] h-[18px]"/>
                        <p>Github</p>
                    </Link>
                    <Link href="https://linkedin.com/in/pascall-de-creator" target="_blank" className="flex items-center gap-2 pointer-events-auto">
                        <FaLinkedin className="w-[18px] h-[18px]"/>
                        <p>LinkedIn</p>
                    </Link>
                </div>

                <Link href="/resume.pdf" target="_blank" className="p-3 border-2 border-primary bg-primary/40 rounded-lg flex items-center justify-center pointer-events-auto">View CV</Link>
            </div>
                ...
                <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="flex flex-wrap items-center gap-4 sm:grid sm:grid-cols-2 lg:grid-cols-3 sm:grid-flow-row sm:items-stretch">
                        <Card className="flex flex-col gap-4 p-4 pt-20 border-2 border-primary bg-primary/40 rounded-lg">
                            <div className="w-max h-max p-4 bg-background-900/20 rounded-full"><BsFillLaptopFill /></div>
                            <div className="flex flex-col gap-2">
                        ...
                        <Card className="flex flex-col gap-4 p-4 pt-20 border-2 border-primary bg-primary/40 rounded-lg">
                            <div className="w-max h-max p-4 bg-background-900/20 rounded-full"><FaDatabase /></div>
                            <div className="flex flex-col gap-2">
                        ...
                        <Card className="flex flex-col gap-4 p-4 pt-20 border-2 border-primary bg-primary/40 rounded-lg">
                            <div className="w-max h-max p-4 bg-background-900/20 rounded-full"><FaMobile /></div>
                            <div className="flex flex-col gap-2">
                        ...
                        <Card className="flex flex-col gap-4 p-4 pt-20 border-2 border-primary bg-primary/40 rounded-lg">
                            <div className="w-max h-max p-4 bg-background-900/20 rounded-full"><AiOutlineDesktop /></div>
                            <div className="flex flex-col gap-2">
