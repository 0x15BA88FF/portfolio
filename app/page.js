    ...
    return (
			<section className="h-full w-full flex container mx-auto items-center justify-center">
				<div className="flex flex-col gap-4 justify-center w-max">
					<span className="text-accent-500 font-bold">Hi there, I am</span>
					...
					<Link className="w-max py-3 px-8 sm:py-4 sm:px-10 border-2 rounded-md font-bold border-primary-500 hover:bg-primary-500/40" href="/about">About Me</Link>
				</div>
			</section>
    );
};
